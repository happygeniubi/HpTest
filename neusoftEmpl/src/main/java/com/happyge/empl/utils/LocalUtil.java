...
public class LocalUtil {
    //各地区xml文件路径//D:\spinach's remember\专业\ideass\neusoftEmpl\src\main\resources
     ...
     *
     * @author      lyc
     * @TODO        功能：根据市名，获取该市地区名列表
     * @time        2016-8-26 上午9:15:24
     * @param
     * @param provinceName
     * @return
     */
    private List<Element> Region(String countryName, String provinceName,String city){


        List<Element> cities =this.cities(countryName,provinceName);
        List<Element> region  = new ArrayList<Element>();
     ...
     * @return
     */
    public List<String> getRegion(String countryName, String provinceName,String city){
        List<Element> tmp =  this.Region(countryName, provinceName,city);
        List<String> region = new ArrayList<String>();
        for(int i=0; i<tmp.size(); i++){
            region.add(tmp.get(i).attributeValue("Name"));
        }
        return region;
    }
